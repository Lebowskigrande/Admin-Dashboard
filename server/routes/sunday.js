...
router.get('/schedule-roles', (req, res) => {
...
router.post('/schedule-roles/auto-next-month', (req, res) => {
...
router.post('/schedule-roles/auto-week', (req, res) => {
    const { date } = req.body || {};
    if (!date) {
        return res.status(400).json({ error: 'date is required' });
    }
