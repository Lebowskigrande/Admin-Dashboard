...
import { FaFolderOpen, FaMapMarkerAlt, FaSave } from 'react-icons/fa';
...
export const buildEventEditorDraft = (details) => ({
...
const EventEditorPanel = ({
    ...
    const canMarkFuture = currentListKey
        ...
        && Array.isArray(details.package?.tasks)
        && details.package.tasks.some((task) => task.list_key === currentListKey);
...
export const renderPanelContent = ({ panelData, selectedSectionKey, originRoute, eventEditorProps, ordersPanelProps }) => {
